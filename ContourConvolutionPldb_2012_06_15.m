...
IRFolder='/Users/mandalin/Desktop/Xcode Output/CompleteRoof -Unfiltered-rooffix/2';
cd(IRFolder)
IRlisting=dir();
...
cd('/Users/mandalin/Desktop/Xcode Output/CompleteRoof -Unfiltered-rooffix/ConvolvedOuts');

%  OutputPLdB_File_fid=fopen('PLdB_Contour_Output3.txt','w')
%  OutputPmax_File_fid=fopen('Pmax_Contour_Output3.txt','w')
  OutputNumRefs_File_fid=fopen('NumRefs_Contour_Output.txt','w')
%   
